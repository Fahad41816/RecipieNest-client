...
import { AddUserRecipe } from "@/src/services/Recipie";
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      ...
      const recipeData = {
        ...
        cookingTime: finalFormData.timeDuration,
        image: finalFormData.image,
        user: user._id,
        tags: finalFormData.tags,
      };

      const responce = await AddUserRecipe(recipeData);
  ...
  return (
    ...
    >
      ...
      <div className="mb-4 ">
        ...
        <Tiptap onDescrptionChange={handleDescriptionChange} />
      </div>
      ...
      <div className="mt-6 flex justify-center">
        <Button type="submit" disabled={isAddProccess} color="primary">
          Add Recipe
        </Button>
      </div>
    </form>
